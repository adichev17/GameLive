    ...
    public partial class Form1 : Form
    {
        ...
        private void NextGeneration()
        {
            ...
            for (int x = 0; x < field.GetLength(0); x++)
            {
                ...
                {
                    if (field[x, y])
                        graphics.FillRectangle(Brushes.OrangeRed, x * resolution, y * resolution, resolution, resolution);// x y координаты, res res высота ширина.
                }
            }

            
            pictureBox1.Refresh(); // Перерисовываем картинку
            Text = $"Generation {gameEngine.currentGeneration}";
